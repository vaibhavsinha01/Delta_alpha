...
class MartingaleManager:
    ...
    def track_orders(self, position_order_id, sl_order_id, tp_order_id, tp_price, sl_price, entry_price):
...
while True:
    ...
    # Only process new signals if not currently monitoring orders
    if entry_signal and not martingale_manager.monitoring_active:
        ...
        try:
            ...
            if position_order and position_order_id:
                ...
                if sl_order_id and tp_order_id:
                    ...
                    martingale_manager.track_orders(position_order_id, sl_order_id, tp_order_id, tp, sl, entry_price)
