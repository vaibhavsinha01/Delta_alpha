...
BINANCE_INTERVAL = '5m'  # Candle interval
...
RENTRY_TIME_BINANCE = 120 # this is the time in seconds to enter once the trade has been closed for binance
...
DELTA_INTERVAL = "15m" 
DELTA_SL_BUFFER_POINTS = 9
DELTA_TP_PERCENT = 0.55
